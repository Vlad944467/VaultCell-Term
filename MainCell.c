...
void input_ () {
    ...
    char term[50], ch_w[10], ex2[8], i_save[50], Fch[15];
    ...
    while (1) {   
        ...
        switch (inp_num) {
            case 1:
                printf("\n%s - Смотреть ячейку один\n",cname[0]);printf("Vcell2 - Смотреть ячейку два\n",cname[1]);
